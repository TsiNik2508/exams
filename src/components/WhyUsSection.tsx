...
const reasons = [
  { title: 'Отбор преподавателей', desc: '3 этапа: опыт, знание предмета, навыки', icon: <EmojiEventsIcon sx={{ color: '#1e7dbd', fontSize: 40 }} />, badge: 'ТОП', badgeColor: '#f2aa8d' },
...
const WhyUsSection = () => (
  <Box sx={{ py: 8, background: '#e3f2fd', position: 'relative', overflow: 'hidden' }}>
    <BackgroundPattern color="#1e7dbd" size={320} top={-80} left={-80} />
    <BackgroundPattern color="#f2aa8d" size={220} bottom={-60} right={-60} />
    <Typography variant="h4" textAlign="center" sx={{ mb: 6, fontWeight: 700, color: '#1e7dbd' }}>
