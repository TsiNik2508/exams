...
const getPricingByExamType = (examType: string) => {
  switch (examType) {
    case 'ЕГЭ':
      return [
        { title: 'Группы до 8 человек', price: '5 900 ₽/мес', description: 'Эффективная групповая подготовка', features: ['4 занятия в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Пробные ЕГЭ', 'Групповое взаимодействие'], buttonText: 'Выбрать' },
        ...
        { title: 'Курс 1 + X', price: 'от 11 210 ₽/мес', description: 'Полное погружение', features: ['От 8 занятий в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Пробники', 'Личные чаты с преподавателями и учениками'], buttonText: 'Выбрать' },
      ];
    case 'ОГЭ':
      return [
        { title: 'Пробный урок', price: '0 ₽', description: 'Знакомство и определение уровня', features: ['Длительность 45 минут', 'Рекомендации по подготовке'], buttonText: 'Записаться' },
        { title: 'Курс ОГЭ', price: '5400 ₽/мес', description: 'Полный курс подготовки к ОГЭ', features: ['4 занятий в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Групповое взаимодействие'], buttonText: 'Выбрать' },
        { title: 'Курс 1 + X', price: '10 260 ₽/мес', description: 'Полное погружение', features: ['От 8 занятий в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Пробники', 'Личные чаты с преподавателями и учениками'], buttonText: 'Выбрать' },
      ];
    case '5-8 класс':
      return [
        { title: 'Пробный урок', price: '0 ₽', description: 'Знакомство и определение уровня', features: ['Длительность 45 минут', 'Рекомендации по подготовке'], buttonText: 'Записаться' },
        { title: 'Базовый курс', price: '4 900 ₽/мес', description: 'Основная программа для 5-8 классов', features: ['4 занятия в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Групповое взаимодействие'], buttonText: 'Выбрать' },
        { title: 'Курс 1 + X', price: '9 310 ₽/мес', description: 'Полное погружение', features: ['От 8 занятий в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Пробники', 'Личные чаты с преподавателями и учениками'], buttonText: 'Выбрать' },
      ];
    case 'Онлайн курс':
      return [
        { title: 'Группы до 8 человек', price: 'от 4 900 ₽/мес', description: 'Эффективная групповая подготовка', features: ['4 занятия в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Онлайн материалы', 'Групповое взаимодействие'], buttonText: 'Выбрать' },
        { title: 'Пробный урок', price: '0 ₽', description: 'Знакомство и определение уровня', features: ['Длительность 45 минут', 'Рекомендации по подготовке'], buttonText: 'Записаться' },
        { title: 'Курс 1 + X', price: 'от 9 310 ₽/мес', description: 'Полное погружение', features: ['От 8 занятий в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Пробники', 'Личные чаты с преподавателями и учениками'], buttonText: 'Выбрать' },
      ];
    default:
      return [
        { title: 'Группы до 8 человек', price: '5 900 ₽/мес', description: 'Эффективная групповая подготовка', features: ['4 занятия в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Групповое взаимодействие'], buttonText: 'Выбрать' },
        { title: 'Пробный урок', price: '0 ₽', description: 'Знакомство и определение уровня', features: ['Длительность 45 минут', 'Рекомендации по подготовке'], buttonText: 'Записаться' },
        { title: 'Курс 1 + X', price: 'от 11 210 ₽/мес', description: 'Полное погружение', features: ['От 8 занятий в месяц', '135 мин (3 ак.ч)', 'Проверка ДЗ', 'Пробники', 'Личные чаты с преподавателями и учениками'], buttonText: 'Выбрать' },
      ];
  }
