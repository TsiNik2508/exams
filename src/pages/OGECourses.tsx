...
const subjects = [
  {
    ...
    topics: ['Алгебра', 'Геометрия', 'Реальная математика'],
  },
  {
    name: 'Русский язык',
  ...
  },
  {
    ...
    topics: ['Механика', 'Электродинамика', 'Оптика'],
  },
  {
    name: 'Информатика',
    description: 'Подготовка к ОГЭ по информатике',
    topics: ['Программирование', 'Алгоритмы', 'Базы данных'],
  },
];
